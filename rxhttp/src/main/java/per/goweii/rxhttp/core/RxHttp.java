...
public class RxHttp {
    ...
    public static void initDownload(DownloadSetting setting) {
    ...
    public static <T, R extends BaseResponse<T>> RxRequest<T, R> request(Observable<R> observable) {
        return RxRequest.create(observable);
    }

    public static RxDownload download(DownloadInfo info) {
