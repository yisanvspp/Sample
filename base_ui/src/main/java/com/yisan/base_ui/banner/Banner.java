...
import com.yisan.base_ui.banner.listener.OnBannerClickListener;
import com.yisan.base_ui.banner.listener.OnBannerListener;
import com.yisan.base_ui.banner.loader.ImageLoaderInterface;
import com.yisan.base_ui.banner.view.BannerViewPager;
...
/**
 * 第三方banner库，Android广告图片轮播控件，支持无限循环和多种主题，可以灵活设置轮播样式、动画、轮播和切换时间、位置、图片加载框架等！
 * <p>
 * 学习源码
 *
 * @author https://github.com/youth5201314/banner
 * @packageName com.yisan.base_ui.banner
 * @fileName Banner.java
 * @date 2019-11-04  下午 2:56
 */
